...
?>
<form action="trans_browse_studresult.php" method="post" enctype="multipart/form-data" onsubmit="return validate_form(this)">
 <fieldset>
 <legend><strong>Viewing  Term Results</strong></legend>
      <table width="700" style="border: 1px solid #d5dfec;" align="center">
        <!--DWLayoutTable-->
        <tr>
          <td colspan="18" align="left" valign="middle" class="ruler" bgcolor="#dddddd"><h2>Viewing Class Results</h2></td>
        </tr>
        <tr>
