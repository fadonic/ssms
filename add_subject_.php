...
with (thisform)
  {
  if (validate_required(school,"Please Select School Type!")==false)
...
!(/^[A-z&#/209;&#241;0-9]*$/i).test(f.value)?f.value = f.value.replace(/[^A-z&#/209;&#241;0-9]/ig,''):null;
      ...
      <form action="add_subject.php" method="post" enctype="multipart/form-data" onsubmit="return validate_form(this)">
      <fieldset><legend><strong>Add Subject For:
      </strong> </legend>
        <table width="715" height="147" align="center" style="border: 1px solid #d5dfec;">
          <!--DWLayoutTable-->
          <tr>
            <td height="32" colspan="18" align="left" valign="middle" bgcolor="#EAEAEA" class="ruler"><h2>Adding Subject by class Category</h2></td>
          </tr>
          <tr>
            <td colspan="18" align="left" valign="middle" class="ruler" ><strong>(</strong> Please Select Class Category<strong>)</strong></td>
          </tr>
          <tr>
            <td width="127" height="32"  align="left" valign="middle"><strong>Choose School Type:</strong></td>
            <td width="204" align="left" valign="middle"><select name="school">
          ...
          <tr>
            ...
            <td width="24"  align="left" valign="middle"><!--DWLayoutEmptyCell-->&nbsp;</td>
          </tr>
          <tr>
